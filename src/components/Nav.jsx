...
setbutton('oops this is dummy site')
  ...
  return (
    ...
    <div className='flex justify-end space-x-3 gap-5 mr-36 p-1 '>
        <Link to='/' className=' text-black hover:bg-pink-600 hover:text-white rounded-lg scale-1 p-2' >Home</Link> 
        <Link to='/services' className=' text-black hover:bg-pink-500 hover:text-white rounded-lg scale-1 p-2'>Services</Link>
        <Link to='/tuining' className=' text-black hover:bg-pink-400 hover:text-white rounded-lg scale-1 p-2'>Tuining</Link>
        <Link to='/about' className=' text-black hover:bg-pink-300 hover:text-white rounded-lg scale-1 p-2'>About</Link>
